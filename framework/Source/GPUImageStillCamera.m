...
{
  if (!(self = [super initWithSessionPreset:sessionPreset cameraPosition:cameraPosition captureAsYUV:yuv]))
  {
    return nil;
  }
...
{
  if (!(self = [self initWithSessionPreset:AVCaptureSessionPresetPhoto cameraPosition:AVCaptureDevicePositionBack captureAsYUV:NO]))
  {
    return nil;
  }
  return self;
